		...
		<div class="item-1">
			<div class="row">
				...
				<div class="col w-full md:w-12/12 lg:w-1/2">
					<div class="item-1-right">
						<div class="row">
							<xsl:apply-templates select="News[position() > 2 and position() &lt; 7]" mode="Small"/> 
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col w-full md:w-12/12 lg:w-1/2">
					<div class="item-1-left">
						<div class="row">
							<xsl:apply-templates select="News[position() > 6 and position() &lt; 9]" mode="Big"/>
						</div>
					</div>
				</div>
				<div class="col w-full md:w-12/12 lg:w-1/2">
					<div class="item-1-right">
						<div class="row">
							<xsl:apply-templates select="News[position() > 8 ]" mode="Small"/>  
						</div>
					</div>
				</div>
			</div>
